...
namespace PropertyManagement.Controllers
{
    public class HousesForRentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ISBN,NumberOfRooms,NumberOfBathrooms,NumberOfBedrooms,ImageUrl,Avaibility,RentalPrice,DateAdded,Owner,Address")] House1 house1)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ISBN,NumberOfRooms,NumberOfBathrooms,NumberOfBedrooms,ImageUrl,Avaibility,RentalPrice,DateAdded,Owner,Address")] House1 house1)
        {
            if (ModelState.IsValid)
            {
